...
import berlin.security.tokens.personnel.MakePersonAUserToken;
...
public class PersonDao extends CommonEntityDao<Person> implements IPerson {
    ...
    protected IFetchProvider<Person> createFetchProvider() {
        return super.createFetchProvider().with("key", "desc", "user", "title", "employeeNo", 
                                                "phone", "mobile", "email");
    }
