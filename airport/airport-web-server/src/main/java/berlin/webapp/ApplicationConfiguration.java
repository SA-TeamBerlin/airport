...
import berlin.webapp.WebUiResources;
import berlin.dbsetup.HibernateSetup;
import berlin.filter.NoDataFilter;
import berlin.ioc.WebApplicationServerModule;
...
/**
 * Configuration point for Berlin Airport Asset Management Web Application.
 * 
 * @author Generated
 * 
 */
        ...
        try {
            ...
            getDefaultHost().attach(
                    new WebUiResources(
                            ...
                            injector,
                            "Berlin Airport Asset Management",
                            "An application server for Berlin Airport Asset Management",
                            "Berlin Asset Management Pty. Ltd.",
                            "Authors",
                            webApp
                            ));
